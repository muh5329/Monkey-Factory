    ...
    return (<>
        ...
        <div className='grid grid-cols-4 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-4  min-[320px]:grid-cols-1 justify-items-center  p-10 '>
          {projectList.map((project, i) =>
            <div key={i}
              className='rounded-lg flex flex-col  col-span-1 row-span-1 m-5 bg-gradient-to-r from-cyan-500 to-blue-500 w-[250px] h-[200px] border-dashed border-2 border-sky-500  '>
              ...
              <div className='relative '>
                ...
                <div className=' text-slate-50 font-bold pl-3 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-lg  border-dashed border-2 border-fuchsia-300 z-30 absolute bottom-0 left-0 w-[95%]' >
                  {project.name}
                </div>

                <a target="_blank" rel="noopener noreferrer" href={project.repo ?? ""}>
                  <div className=' bg-gradient-to-r from-purple-500 to-pink-500 col-span-1 z-40 absolute bottom-0 right-0 rounded-lg border-dashed border-2 border-pink-400' >
                    <Image
